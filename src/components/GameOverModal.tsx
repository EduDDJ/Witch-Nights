...
export const GameOverModal: React.FC<GameOverModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/90 backdrop-blur-md p-4 animate-in fade-in duration-300">
      <div className="w-full max-w-lg bg-gradient-to-b from-stone-950 via-rose-950/40 to-stone-950 border-2 border-rose-600/70 rounded-3xl p-6 sm:p-8 shadow-2xl shadow-rose-950/70 text-center relative">
        <div className="w-16 h-16 rounded-2xl bg-rose-950 border border-rose-600/60 flex items-center justify-center mx-auto mb-4 text-rose-400 shadow-xl shadow-rose-950/50">
          <Skull className="w-9 h-9" />
        </div>

        <h2 className="text-2xl sm:text-3xl font-black font-serif text-transparent bg-clip-text bg-gradient-to-r from-red-400 via-rose-200 to-amber-200 tracking-wide mb-1 uppercase">
          THE WITCH WAS DEFEATED BY {stats.killerName || 'THE SHADOWS'}
        </h2>
        <p className="text-stone-400 text-xs sm:text-sm mb-6">
          The shadows have claimed your soul. Your deeds are engraved in the Grimoire.
        </p>

        {/* Stats Grid */}
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-6 bg-stone-900/80 p-3.5 rounded-2xl border border-stone-800">
          ...
          <div className="flex flex-col p-1 border-t border-l border-stone-800 sm:border-t-0 sm:border-l sm:border-stone-800">
